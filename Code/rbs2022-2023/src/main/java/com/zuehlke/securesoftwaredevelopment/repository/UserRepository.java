...
import com.zuehlke.securesoftwaredevelopment.controller.MoviesController;
...
public class UserRepository {
    ...
    public boolean validCredentials(String username, String password) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            AuditLogger.getAuditLogger(DatabaseAuthenticationProvider.class)
                    .audit("User logged in with username " + username);
            return rs.next();
        } catch (SQLException e) {
            LOG.warn("User failed to login with username " + username);
        }
        return false;
    }
    ...
    public void delete(int userId) {
        ...
        try (Connection connection = dataSource.getConnection();
            ...
            AuditLogger.getAuditLogger(DatabaseAuthenticationProvider.class)
                    .audit("Profile of user " + userId + " is deleted");
        } catch (SQLException e) {
